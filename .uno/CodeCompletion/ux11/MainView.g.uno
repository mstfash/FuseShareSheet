...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp18 = new PageWithTitle();
        var temp19 = new Fuse.Controls.Panel();
        var temp20 = new Fuse.Gestures.WhilePressed();
        var temp21 = new Fuse.Animations.Rotate();
        var temp22 = new Fuse.Animations.Scale();
        var temp23 = new Fuse.Animations.Change<float4>(myRectangle_Color_inst);
        var temp24 = new Fuse.Animations.Change<float4>(myRectangle_CornerRadius_inst);
        var temp25 = new PageWithTitle();
        var temp26 = new Fuse.Reactive.JavaScript(__g_nametable);
        var temp27 = new Fuse.Controls.Panel();
        var temp28 = new Fuse.Controls.ScrollView();
        var temp29 = new Fuse.Controls.Panel();
        var temp30 = new Fuse.Layouts.ColumnLayout();
        var item = new Template(this, this);
        var temp31 = new Fuse.Reactive.DataBinding<object>(temp_Items_inst, "items");
        temp_eb0 = new Fuse.Reactive.EventBinding("addItem");
        var temp32 = new PageWithTitle();
        var temp33 = new Fuse.Controls.Grid();
        var temp34 = new Fuse.Controls.Image();
        var temp35 = new Fuse.Controls.Slider();
        var temp36 = new Fuse.Triggers.ProgressAnimation();
        var temp37 = new Fuse.Animations.Change<float>(myBlur_Radius_inst);
        temp16.Children.Add(temp17);
        temp17.Children.Add(temp18);
        temp17.Children.Add(temp25);
        temp17.Children.Add(temp32);
        temp18.Title = "Basic animation";
        ...
        temp18.Instructions = "Tap and hold the rectangle";
        temp18.Children.Add(temp19);
        temp19.Children.Add(myRectangle);
        ...
        myRectangle.Children.Add(temp20);
        ...
        temp23.Value = float4(0.9882353f, 0.3176471f, 0.5215687f, 1f);
        temp23.Duration = 0.3;
        temp24.Value = float4(15f, 15f, 15f, 15f);
        temp24.Duration = 0.3;
        temp25.Title = "Logic with JavaScript";
        temp25.Color = float4(1f, 1f, 1f, 1f);
        temp25.HeaderColor = float4(0.9647059f, 0.5607843f, 0.8431373f, 1f);
        temp25.HeaderTextColor = float4(1f, 1f, 1f, 1f);
        temp25.Instructions = "Tap the screen to add items";
        temp25.Children.Add(temp26);
        temp25.Children.Add(temp27);
        temp26.Code = "var Observable = require('FuseJS/Observable');\n\t\t\t\t\titems = Observable();\n\t\t\t\t\tfunction addItem(){\n\t\t\t\t\t\titems.add({\n\t\t\t\t\t\t\tcolor : [Math.random(), Math.random(), Math.random(), 1],\n\t\t\t\t\t\t\theight : (Math.random() + 1.0) * 80\n\t\t\t\t\t\t});\n\t\t\t\t\t}\n\t\t\t\t\tmodule.exports = {\n\t\t\t\t\t\titems : items,\n\t\t\t\t\t\taddItem : addItem\n\t\t\t\t\t};";
        temp26.LineNumber = 37;
        temp26.FileName = "MainView.ux";
        global::Fuse.Gestures.Tapped.AddHandler(temp27, temp_eb0.OnEvent);
        temp27.Children.Add(temp28);
        temp27.Bindings.Add(temp_eb0);
        temp28.Children.Add(temp29);
        temp29.Layout = temp30;
        temp29.Children.Add(temp);
        temp30.ColumnCount = 3;
        temp.Templates.Add(item);
        temp.Bindings.Add(temp31);
        temp32.Title = "Realtime effects";
        temp32.Color = float4(1f, 1f, 1f, 1f);
        temp32.HeaderColor = float4(0.172549f, 0.682353f, 0.2470588f, 1f);
        temp32.HeaderTextColor = float4(1f, 1f, 1f, 1f);
        temp32.Instructions = "Use the slider to blur the logo";
        temp32.Children.Add(temp33);
        temp33.RowCount = 2;
        temp33.Children.Add(temp34);
        temp33.Children.Add(temp35);
        temp34.Color = float4(0f, 0f, 0f, 1f);
        temp34.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../Assets/FuseLogo.png"));
        temp34.Children.Add(myBlur);
        myBlur.Radius = 0f;
        myBlur.Name = __selector5;
        temp35.Alignment = Fuse.Elements.Alignment.VerticalCenter;
        temp35.Margin = float4(40f, 0f, 40f, 0f);
