...
void GraphicsWorker::Run()
{
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            {
                ::g::Uno::Exception* e = __t.Exception;
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[44/*"GraphicsWor...*/], e, a, ::STRINGS[3/*"/Users/most...*/], 2891, ::STRINGS[45/*"Run"*/]);
...
LayoutParams LayoutParams::DeriveClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[47/*"Use CloneAn...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[3/*"/Users/most...*/], 3408, ::STRINGS[48/*"DeriveClone"*/]);
...
LayoutParams LayoutParams::TrueClone()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[49/*"Use Clone i...*/], uBox(LayoutParams_typeof(), *this), ::STRINGS[3/*"/Users/most...*/], 3379, ::STRINGS[50/*"TrueClone"*/]);
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[69] = uString::Const("/Users/mostafa/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/0.42.4/$.uno");
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"UserEvent r...*/], __this, ::STRINGS[69/*"/Users/most...*/], 638, ::STRINGS[70/*"OnRooted"*/]);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    ...
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[73/*"Trying to R...*/], this, ::STRINGS[69/*"/Users/most...*/], 685, ::STRINGS[74/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[71/*"Raise must ...*/], n, ::STRINGS[69/*"/Users/most...*/], 421, ::STRINGS[67/*"raise"*/]);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[72/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[69/*"/Users/most...*/], 428, ::STRINGS[67/*"raise"*/]);
        return;
    }
...
void UserEvent::RaiseEvent(::g::Fuse::Visual* from, ::g::Uno::UX::Selector name, ::g::Uno::Collections::Dictionary* args)
{
    ...
    if (ev == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::STRINGS[75/*"Unknown eve...*/], ::g::Uno::UX::Selector__op_Implicit1(name)), NULL, ::STRINGS[69/*"/Users/most...*/], 698, ::STRINGS[76/*"RaiseEvent"*/]);
        return;
    }
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[85/*"Invalid Rai...*/], 1, ::STRINGS[3/*"/Users/most...*/], 2127);
            return;
        }
    }
