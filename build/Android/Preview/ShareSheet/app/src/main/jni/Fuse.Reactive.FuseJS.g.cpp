...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], uPtr(::g::FuseReactive_bundle::es6promisemindcd92cac())->ReadAllText());
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], ::STRINGS[4/*"ES6Promise....*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactive_bundle::Observabled73eeeb6()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
