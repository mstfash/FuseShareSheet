...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.7.49"), 12124)}, "/Users/mostafa/Desktop/ShareSheet/ShareSheet.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("ShareSheet");
}
}
}
