#!/bin/bash
# This file was generated based on '/Users/mostafa/Library/Application Support/Fusetools/Packages/UnoCore/0.42.5/targets/ios/build.sh'.
...
##else
    xcodebuild -project "ShareSheet.xcodeproj" "$@" | tee >(checkForError)
##endif
