...
namespace g{struct ShareSheet_FuseControlsShape_Color_Property;}
...
struct ShareSheet_FuseControlsShape_Color_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Controls::Shape*> _obj;

    void ctor_2(::g::Fuse::Controls::Shape* obj, ::g::Uno::UX::Selector name);
    static ShareSheet_FuseControlsShape_Color_Property* New1(::g::Fuse::Controls::Shape* obj, ::g::Uno::UX::Selector name);
};
// }
