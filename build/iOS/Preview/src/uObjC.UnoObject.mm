...
+ (instancetype)strongUnoObjectWithUnoObject:(uObject*)object
{
	...
	return [[[StrongUnoObject alloc] initWithUnoObject: object] autorelease];
}
...
+ (instancetype)weakUnoObjectWithUnoObject:(uObject*)object
{
	...
	return [[[WeakUnoObject alloc] initWithUnoObject: object] autorelease];
}
...
+ (instancetype)unsafeUnoObjectWithUnoObject:(uObject*)object
{
	...
	return [[[UnsafeUnoObject alloc] initWithUnoObject: object] autorelease];
}
